  ...
  return (
    <div key={item._id} className="carouselItem" interval="500">
      <div className="feature-textBlock row">
        <div className="col-6 text-of-card">
          ...
          <div className="ratingAndReview">
            <ul class="rating">
              {Array.apply(null, { length: 5 }).map((e, i) => (
                <li>
                  <i
                    class={i >= item?.rating ? `bi bi-star` : `bi bi-star-fill`}
                    id="review-icon"
                  ></i>
                </li>
              ))}
        ...
        <div className="know-more-but">
          <button
            className="cart-btn"
            onClick={() => {
              scrollToTop();
              knowmoreHandler(item._id);
            }}
          >
            Know More
          </button>
