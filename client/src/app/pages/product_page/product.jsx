        ...
        <div className="single-product bg">
                ...
                <div className="container">
                   ...
                   <div className="ratingAndReview">
                    ...
                    <button className='cart-btn'>Add to Cart</button>
                     <div>
                      <span><i class="bi bi-heart-fill" id='wishlist-icon'></i></span>
                      <a href='/' className='wishlist'>Add to wishlist</a>
                      </div>
                    </div>
                    </div>
                   </card>
                  ...
                  <div className='carousel-card'>
                        <div className='single-carousel-card'>
                            ...
                            <div className="more-card">
                                ...
                                <span className="more-icon"><i  class="bi bi-arrow-right"></i></span>
                            </div>
             ...
             <div className='review-section ' >
                <div className="review-card card">
                    ...
                    <sup><button className='review-btn'>128</button></sup>
                    </div>
                 <div className="ratingAndReview">
                    <ul class="rating">
                        <li><i class="bi bi-star-fill" id='review-icon'></i></li>
                    ...
                    <div className="input-form">
                        <div>
                        <textarea type='message' className='input' placeholder='Hey! @name, it’s a very good design.🔥' />
                        </div>
                        <div>
                    ...
                    <div className="review-description">
                        <div className="user-review">
                            ...
                            <span className='user-icon'><i class="bi bi-person-circle"></i></span>
                            <h3 className='personName'>Person's Name</h3>
                            </div>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates error velit aspernatur deleniti dolorum 
                                reprehenderit! Tenetur doloribus aspernatur vel ullam? Tempore eius accusamus placeat
                                 dolorum odio earum ab repellendus tempora.</p>
                        </div>
                        ...
                        <button className='load-more'>Load More<i class="bi bi-chevron-down"></i> </button>
                    </div>
                </div>
