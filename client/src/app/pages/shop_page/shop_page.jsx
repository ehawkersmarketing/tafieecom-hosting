            ...
            <div className="view-more">
              <div className="poster-text">
                ...
                <span className="description-text">
                  Nourish your soil for healthier crops. Our range of
                  fertilizers and soil enhancers is designed to optimize growth
                  and maximize yield.
                </span>
              </div>
                ...
                searchProducts?.map((product) => {
                  return (
                    <div style={{ width: "26rem" }}>
                      <ProductCard item={product} className="productItem" />
                    </div>
                  );
                })
              ) : (
