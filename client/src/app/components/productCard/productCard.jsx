...
const ProductCard = ({ cart, item }) => {
  ...
  return (
    <div
      key={item._id}
      className="carouselItem col-md-4 col-lg-3 col-sm-6"
      interval="500"
    >
      <div className="col-gapping">
        <div className="textBlock ">
          ...
          <div className="text-fields d-flex flex-column justify-content-between">
            <div>
                  ...
                  <ul class="rating">
                    {Array.apply(null, { length: 5 }).map((e, i) => (
                      <li>
                        <i
                          class={
                            i >= item.rating ? `bi bi-star` : `bi bi-star-fill`
                          }
                          id="review-icon"
                        ></i>
                      </li>
